...
import { Moon, Sun, Music, HelpCircle, LogOut, LogIn, ChevronDown } from "lucide-react"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold">Music Transfer</span>
          </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="sm" className="flex items-center gap-2">
                    ...
                    <span className="hidden sm:inline">{session.user?.email?.split('@')[0] || session.user?.name || "Spotify"}</span>
